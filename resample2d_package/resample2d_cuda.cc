...
int resample2d_cuda_forward(
    ...
    int kernel_size,
    int dilation) {
      resample2d_kernel_forward(input1, input2, output, kernel_size, dilation);
    return 1;
}
...
int resample2d_cuda_backward(
    ...
    int kernel_size,
    int dilation) {
        resample2d_kernel_backward(input1, input2, gradOutput, gradInput1, kernel_size, dilation);
    return 1;
}
